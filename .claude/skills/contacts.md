...
node /claude_wa/contacts.js add --phone <phone> --name "<name>" --description "<description>"

# Edit an existing contact (omit flags you don't want to change)
node /claude_wa/contacts.js edit --phone <phone> --name "<name>" --description "<description>"

# Remove a contact
node /claude_wa/contacts.js remove --phone <phone>

# Get a specific contact
node /claude_wa/contacts.js get --phone <phone>

# List all contacts
node /claude_wa/contacts.js list
```
